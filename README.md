...
##### NEGATIVE SCORE 
- This score is calculated by assigning the value of -1 for each word if found in the Negative Dictionary and then adding up all the values. I multiplied the score with -1 so that the score is a positive number.
##### POLARITY SCORE 
